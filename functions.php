...
<div class="tm-sub-footer uk-text-center uk-text-muted">
    <p>© <?php echo date('Y'); ?>
		<a href="<?php echo site_url();?>" target="_blank" title="Applifting">App<span>Lifting</span></a> - an <a href="http://www.applifting.com/" title="Applifting" target="_blank">Applifting</a> Group Company </p>
    </div>
    <?php
}
